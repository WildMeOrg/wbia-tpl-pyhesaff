...
# PYHESAFF_FOUND - True if PyHesaff was found.
# PYHESAFF_INCLUDE_DIRS - Directories containing the PyHesaff include files.
# PYHESAFF_LIBRARIES - Libraries needed to use PyHesaff.
...
find_library(PYHESAFF_LIBRARY pyhesaff
    HINTS ${PC_PYHESAFF_LIBDIR} ${PC_PYHESAFF_LIBRARY_DIRS})

set(PYHESAFF_INCLUDE_DIRS ${PYHESAFF_INCLUDE_DIR})
set(PYHESAFF_LIBRARIES ${PYHESAFF_LIBRARY})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(PyHesaff DEFAULT_MSG
